        ...
        {images.map((img, i) => (
          ...
          >
            <button
              ...
              className="group relative block aspect-[4/3] w-full overflow-hidden rounded-md border border-hairline/10 bg-bg-elev transition-[border-color,box-shadow] duration-300 ease-out hover:border-gold/30 hover:shadow-glow-sm"
